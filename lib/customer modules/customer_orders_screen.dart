...
class _CustomerOrdersScreenState extends State<CustomerOrdersScreen> with SingleTickerProviderStateMixin {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Customer order history is currently empty', 
  ...
  Widget _buildOrderCard(CustomerOrderItem order) {
    final bool isDelivered = order.status.toLowerCase() == 'delivered' || order.status.toLowerCase() == 'completed';
        ...
        children: [
          ...
          Container(
            ...
            child: Stack(
              children: [
                const Center(
                  child: Icon(Icons.receipt_long_outlined, size: 36, color: Color(0xFF26A69A)),
                ),
                Positioned(
                  top: 12,
                  right: 12,
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (isDelivered ? Colors.green : Colors.orange).withOpacity(0.1),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  order.orderNo.isNotEmpty ? 'Order #${order.orderNo}' : 'ID: ${order.orderId}',
                  maxLines: 1,
